...
/* Spruce code for OSPURCET-804 by wangzr10 at 2023.1.17 start */
#define AW883XX_ACF_FILE_0	"aw883xx_acf_yc.bin"
#define AW883XX_ACF_FILE_1	"aw883xx_acf_qs.bin"
/* Spruce code for OSPURCET-804 by wangzr10 at 2023.1.17 end */
...
/* modify code for OSPURCET-804 by wangzr10 at 2023.1.17 start */
...
/* modify code for OSPURCET-804 by wangzr10 at 2023.1.17 end */
		if ((ret < 0) || (!cont)) {
...
/* Spruce code for OSPURCET-804 by wangzr10 at 2023.1.17 start */
static ssize_t aw883xx_spk_id_show(struct device *dev,
				struct device_attribute *attr, char *buf)
{
	struct aw883xx *aw883xx = dev_get_drvdata(dev);
	ssize_t len = 0;
...
/* Spruce code for OSPURCET-804 by wangzr10 at 2023.1.17 start */
static DEVICE_ATTR(spk_id, S_IRUGO,
		aw883xx_spk_id_show, NULL);
/* Spruce code for OSPURCET-804 by wangzr10 at 2023.1.17 start */
