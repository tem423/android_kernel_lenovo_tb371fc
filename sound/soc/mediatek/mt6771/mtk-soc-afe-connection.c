...
static const struct connection_link_t mConnectionLink[] = {
	...
	{Soc_Aud_AFE_IO_Block_MEM_DL2,
		Soc_Aud_AFE_IO_Block_DAI_BT_OUT, SetDl2ToDaiBtOut},
	...
	{Soc_Aud_AFE_IO_Block_I2S_CONNSYS,
		Soc_Aud_AFE_IO_Block_MEM_VUL2, SetConnsysToVul2Data},
	{Soc_Aud_AFE_IO_Block_MODEM_PCM_2_I_CH1,
	...
	{Soc_Aud_AFE_IO_Block_MEM_DL3,
		Soc_Aud_AFE_IO_Block_I2S1_DAC, SetDl3ToI2s1Dac},
	{Soc_Aud_AFE_IO_Block_MEM_DL3_CH1,
		Soc_Aud_AFE_IO_Block_I2S1_DAC, SetDl3Ch1ToI2s1Dac},
	{Soc_Aud_AFE_IO_Block_MEM_DL3,
		Soc_Aud_AFE_IO_Block_I2S3, SetDl3ToI2s3},
	{Soc_Aud_AFE_IO_Block_MEM_DL3,
...
{
	/*
	 * pr_info("SetinputConnection ConnectionState = %d
	...
	default:
		pr_info("no this state ConnectionState = %d\n", ConnectionState);
		break;
	}
			    ...
			    unsigned int Aud_block_Out)
{
	bool ret = false;
	connection_function connectionFunction =
		GetConnectionFunction(Aud_block_In,
			Aud_block_Out);

	if (connectionFunction == 0) {
		pr_info("no this connection function\n");
		return ret;
	}
