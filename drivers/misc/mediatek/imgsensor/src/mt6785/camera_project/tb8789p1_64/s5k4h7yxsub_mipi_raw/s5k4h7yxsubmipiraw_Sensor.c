...
#define DEVICE_VERSION_S5K4H7YXSUB    "s5k4h7yxsub"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YXSUB_SENSOR_ID,	/*S5K4H7YXSUB_SENSOR_ID = 0x487A */
...
static kal_uint16 s5k4h7yxsub_init_setting[] = {
	0x0100, 0x00,
	0x0B05, 0x01,
	0x3074, 0x06,
	0x3075, 0x2F,
...
static kal_uint16 s5k4h7yxsub_preview_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 s5k4h7yxsub_cap_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 s5k4h7yxsub_cap1_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 s5k4h7yxsub_normal_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 s5k4h7yxsub_hs_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 s5k4h7yxsub_slim_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
{
	table_write_cmos_sensor(s5k4h7yxsub_init_setting,
		sizeof(s5k4h7yxsub_init_setting) / sizeof(kal_uint16));
}				/*  s5k4h7MIPI_Sensor_Init  */


static void preview_setting(void)
{
	table_write_cmos_sensor(s5k4h7yxsub_preview_setting,
		sizeof(s5k4h7yxsub_preview_setting) / sizeof(kal_uint16));
}				/*  s5k4h7MIPI_Capture_Setting  */

static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 150) {
		table_write_cmos_sensor(s5k4h7yxsub_cap1_setting,
			sizeof(s5k4h7yxsub_cap1_setting) / sizeof(kal_uint16));
	} else {
		table_write_cmos_sensor(s5k4h7yxsub_cap_setting,
			sizeof(s5k4h7yxsub_cap_setting) / sizeof(kal_uint16));
	}
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(s5k4h7yxsub_normal_video_setting,
		sizeof(s5k4h7yxsub_normal_video_setting) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(s5k4h7yxsub_hs_video_setting,
		sizeof(s5k4h7yxsub_hs_video_setting) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k4h7yxsub_slim_video_setting,
		sizeof(s5k4h7yxsub_slim_video_setting) / sizeof(kal_uint16));
}
...
#ifdef VENDOR_EDIT
	/*zhengjiang.zhu@Camera.Drv, 2017/10/18 add for otp */
	otp_flag = S5K4H7YXSUB_otp_update();
	if (otp_flag)
