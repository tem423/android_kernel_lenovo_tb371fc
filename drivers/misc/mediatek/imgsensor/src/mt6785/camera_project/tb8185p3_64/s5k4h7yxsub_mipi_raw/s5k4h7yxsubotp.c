...
unsigned short s5k4h7yxsub_selective_read_region_8(int pageidx, unsigned int addr)
{
	unsigned short get_byte = 0;
 ...
 * **************************************************/
void s5k4h7yxsub_rgb_gain_set(int *r_gain, int *g_gain, int *b_gain,
	...
	int gain_default = 0x0100;
		...
		if (r_ration >= 1) {
			if (b_ration >= 1) {
				...
				*r_gain =
				(int)((gain_default * r_ration * 1000 / b_ration + 500)/1000);
		}
	} else {
		if (b_ration >= 1) {
			*r_gain = gain_default;
...
char r_gain_h, r_gain_l, g_gain_h, g_gain_l, b_gain_h, b_gain_l;
	...
	s5k4h7yxsub_otp_info.ngcur = (unsigned int)((s5k4h7yxsub_otp_info.ngrcur
					+ s5k4h7yxsub_otp_info.ngbcur)*1000/2 + 500);

	s5k4h7yxsub_otp_info.frgcur = (unsigned int)(s5k4h7yxsub_otp_info.nrcur*1000
					/ s5k4h7yxsub_otp_info.ngcur + 500);
	s5k4h7yxsub_otp_info.fbgcur = (unsigned int)(s5k4h7yxsub_otp_info.nbcur*1000
					/ s5k4h7yxsub_otp_info.ngcur + 500);

	s5k4h7yxsub_otp_info.nggolden = (unsigned int)((s5k4h7yxsub_otp_info.ngrgolden
					+ s5k4h7yxsub_otp_info.ngbgolden)*1000 / 2 + 500);

	s5k4h7yxsub_otp_info.frggolden = (unsigned int)(s5k4h7yxsub_otp_info.nrgolden*1000
					/ s5k4h7yxsub_otp_info.nggolden + 500);
	s5k4h7yxsub_otp_info.fbggolden = (unsigned int)(s5k4h7yxsub_otp_info.nbgolden*1000
					/ s5k4h7yxsub_otp_info.nggolden + 500);

	r_ratio = (unsigned int)((s5k4h7yxsub_otp_info.frggolden * 1000
					/ s5k4h7yxsub_otp_info.frgcur + 500)/1000);
	b_ratio = (unsigned int)((s5k4h7yxsub_otp_info.fbggolden * 1000
					/ s5k4h7yxsub_otp_info.fbgcur + 500)/1000);

	s5k4h7yxsub_rgb_gain_set(&s5k4h7yxsub_otp_info.nr_gain, &s5k4h7yxsub_otp_info.ng_gain,
...
int s5k4h7yxsub_otp_group_info(void)
{
	...
	s5k4h7yxsub_otp_info.lsc_infoflag = s5k4h7yxsub_selective_read_region_8(0, 0x0A3D);

	if (s5k4h7yxsub_otp_info.lsc_infoflag == 0x01) {
		s5k4h7yxsub_otp_info.lsc_offset = 0;
		s5k4h7yxsub_otp_info.lsc_group = 1;
		s5k4h7yxsub_otp_info.lsc_checksum = s5k4h7yxsub_selective_read_region_8(24, 0x0A06);
	} else if (s5k4h7yxsub_otp_info.lsc_infoflag == 0x03) {
		s5k4h7yxsub_otp_info.lsc_offset = 1;
		s5k4h7yxsub_otp_info.lsc_group = 2;
		s5k4h7yxsub_otp_info.lsc_checksum = s5k4h7yxsub_selective_read_region_8(24, 0x0A07);
	} else {
	...
	s5k4h7yxsub_otp_info.module_integrator_id =
		s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A05);
	s5k4h7yxsub_otp_info.awb_checksum =
		s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A2D);

	s5k4h7yxsub_otp_info.nrcur =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A1E) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A1F);
	s5k4h7yxsub_otp_info.nbcur =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A25) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A26);
	s5k4h7yxsub_otp_info.ngrcur =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A21) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A22);
	s5k4h7yxsub_otp_info.ngbcur =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A23) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A24);

	s5k4h7yxsub_otp_info.nrgolden =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A11) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A12);
	s5k4h7yxsub_otp_info.nbgolden =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A17) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A18);
	s5k4h7yxsub_otp_info.ngrgolden =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A13) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A14);
	s5k4h7yxsub_otp_info.ngbgolden =
		(s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A15) << 8)
		+ s5k4h7yxsub_selective_read_region_8(s5k4h7yxsub_otp_info.awb_page, 0x0A16);
 ...
 * return true or false
 ********************************************************/
bool s5k4h7yxsub_read_page(int page_start, int page_end, unsigned char *pdata)
{
	bool bresult = true;
...
unsigned int s5k4h7yxsub_checksum_lsc_flag(unsigned int sum_start,
...
bool S5K4H7YXSUB_checksum_lsc(void)
{
	...
	if (s5k4h7yxsub_otp_info.lsc_group == 1) {
		for (page_start = 1, page_end = 6; page_start <= page_end; page_start++) {
			bresult &=
				s5k4h7yxsub_read_page(page_start, page_start, data_p[page_start-1]);
			if (page_start == 6) {
				checksum_lsc +=
				s5k4h7yxsub_checksum_lsc_flag(0x0A04, 0x0A2B, data_p[page_start-1]);
				continue;
			}
			checksum_lsc +=
			s5k4h7yxsub_checksum_lsc_flag(0x0A04, 0X0A43, data_p[page_start-1]);
		}
		...
		for (page_start = 6, page_end = 12; page_start <= page_end; page_start++) {
			...
			if (page_start == 6) {
				checksum_lsc +=
				s5k4h7yxsub_checksum_lsc_flag(0x0A2C, 0x0A43, data_p[page_start-1]);
				continue;
				...
				checksum_lsc +=
				s5k4h7yxsub_checksum_lsc_flag(0x0A04, 0X0A13, data_p[page_start-1]);
			}
		}
	}
...
bool S5K4H7YXSUB_otp_update(void)
{
	...
	if (s5k4h7yxsub_otp_group_info() == -1) {
		...
		if (S5K4H7YXSUB_checksum_awb() == 0 || S5K4H7YXSUB_checksum_lsc() == 0) {
