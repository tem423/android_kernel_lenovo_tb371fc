...
#endif
/*TULIP code for TULIP-847 by guomin at 20220622 start*/
static bool otp_flag = false;
/*TULIP code for TULIP-847 by guomin at 20220622 end*/
...
/*TULIP code for TULIP-5583 by guomin at 20220718 start*/
/*TULIP code for TULIP-3604 by guomin at 20220712 start*/
static struct imgsensor_info_struct imgsensor_info = {
	...
	.margin = 4,
	.min_shutter = 4,
	/*Tulip code for TULIP-8423 by lixin at 2022/8/4 start*/
	.min_gain = 64,
	.max_gain = 1024,
	.min_gain_iso = 100,
	/*Spruce code for OSPURCET-692 by zhangzp16 at 20230105 start*/
	.gain_step = 4,
	/*Spruce code for OSPURCET-692 by zhangzp16 at 20230105 end*/
	/*Tulip code for TULIP-8423 by lixin at 2022/8/4 end*/
	.gain_type = 2,
...
/*TULIP code for TULIP-3604 by guomin at 20220712 end*/
...
static kal_uint16 s5k4h7_init_setting[] = {
	...
	0x3400, 0x00,
	0x0B00, 0x01,
	/*TULIP code for TULIP-607 by zengyu at 20220524 start*/
	/*TULIP code for TULIP-4360 by guomin at 20220708 start*/
	0x3931,	0x01,
	0x392F,	0x01,
	0x3930, 0x80,
	0x3932, 0xc8,
	/*TULIP code for TULIP-4360 by guomin at 20220708 end*/
	/*TULIP code for TULIP-607 by zengyu at 20220524 end*/
...
//Summary      2Bin 1632x1224  30.01fps
//ExtClk :     24      MHz
//Vt_pix_clk : 280     MHz
//MIPI_output_clk :    700     Mbps/lane
//Crop_Width : 3264    px
//Crop_Height :        2448    px
//Output_Width :       1632    px
//Output_Height :      1224    px
...
//Summary	full 3264x2448  15fps
//ExtClk :	24	MHz
//Vt_pix_clk :	280	MHz
//MIPI_output_clk :	400	Mbps/lane
//Crop_Width :	3264 	px
//Crop_Height :	2448 	px
//Output_Width :	3264 	px
//Output_Height :	2448 	px
...
{
	LOG_INF("custom1 currefps--guomin %d",currefps);
...
{
	LOG_INF("enable: %d\n", enable);
	/*Tulip code for TULIP-1860 by lixin at 2022/6/16 start*/
	if (enable)
	{
	...
	/*Tulip code for TULIP-1860 by lixin at 2022/6/16 end*/
	spin_lock(&imgsensor_drv_lock);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
	/*Spruce code for OSPURCET-717 by zhangzp16 at 20230216 start*/
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
 		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1000000;
		break;
	/*Spruce code for OSPURCET-717 by zhangzp16 at 20230216 end*/
	...
	case SENSOR_FEATURE_GET_BINNING_TYPE:
		...
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		default:
			/*Tulip code for TULIP-3818 by lixin at 2022/7/5 start*/
			*feature_return_para_32 = 1; /*BINNING_AVERAGED*/
			/*Tulip code for TULIP-3818 by lixin at 2022/7/5 end*/
			break;
		}
...
/*TULIP code for TULIP-5583 by guomin at 20220718 end*/
