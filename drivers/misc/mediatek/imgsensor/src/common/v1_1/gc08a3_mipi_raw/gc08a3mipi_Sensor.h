...
#define MODULE_AWB_GROUP1_FLAG 0x15a0
#define LSC_GROUP1_FLAG 0x1720
#define AF_GROUP1_FLAG 0x16F0

#define MODULE_AWB_GROUP2_FLAG 0x88e0
#define LSC_GROUP2_FLAG 0x8a60
#define AF_GROUP2_FLAG 0x8a30

#define MODULE_AWB_INFO_FLAG_1 0x15a8
#define LSC_INFO_FLAG_1 0x1728
#define AF_INFO_FLAG_1 0x16F8

#define MODULE_AWB_INFO_FLAG_2 0x88e8
#define LSC_INFO_FLAG_2 0x8a68
#define AF_INFO_FLAG_2 0x8a38

#define GROUP_LENGTH 1915
#define MODULE_AWB_LENGTH 41
#define LSC_LENGTH 1869
#define AF_LENGTH 5

/*Spruce code for OSPURCET-602 by guomin4 at 20221208 start*/
struct gc08a3_otp_t {

	kal_uint8  module_awb_param[40];
	kal_uint8  moduleAwbChksum;
	kal_uint8  af_param[4];
	kal_uint8  afChksum;
	kal_uint8  lsc_param[1868];
	kal_uint8  lscChksum;

	kal_uint8  module_awbflag_1;
	kal_uint8  module_awbflag_2;
	kal_uint8  lsc_flag1;
	kal_uint8  lsc_flag2;
	kal_uint8  af_flag1;
	kal_uint8  af_flag2;
};
/*Spruce code for OSPURCET-602 by guomin4 at 20221208 end*/

union GC08A3_OTP_DATA {
	struct gc08a3_otp_t info;
	kal_uint8 data[1915];
};
