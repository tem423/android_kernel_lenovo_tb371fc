 ...
 *============================================================================
 ****************************************************************************/
#define PFX "HI1339ofilm_camera_sensor"
...
#include "hi1339ofilmmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1339OFILM_SENSOR_ID,

	.checksum_value = 0x20225021,
	.pre = {
		.pclk = 72000000,
		.linelength = 720,
/*Spruce code for OSPURCET-598 by zhangzp16 at 20221206 start*/
		.framelength = 3332,
/*Spruce code for OSPURCET-598 by zhangzp16 at 20221206 end*/
		.startx = 0,
		.starty = 0,
...
static kal_uint16 read_eeprom_8(kal_uint16 addr)
{
	...
	iReadRegI2C(pusendcmd, 2, (u8 *)&get_word, 1, 0xA2);
	return get_word;
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			ofilm_id = read_eeprom_8(0x000B);
			if (ofilm_id != 0x07)
			{

				pr_debug("Read ofilm id fail, i2c slave: 0x%x, read data ofilm id : 0x%x\n",
				0xA2, ofilm_id);
                return ERROR_SENSOR_CONNECT_FAIL;
			}
			pr_debug("Read ofilm id ok, i2c slave: 0x%x, read data ofilm id : 0x%x\n",
				0xA2, ofilm_id);

			*sensor_id = (read_cmos_sensor_8(0x0716) << 8) | read_cmos_sensor_8(0x0717) + 1;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			sensor_id = (read_cmos_sensor_8(0x0716) << 8) | read_cmos_sensor_8(0x0717) + 1;
			if (sensor_id == imgsensor_info.sensor_id) {
				pr_debug("i2c write id: 0x%x, ofilm sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		write_cmos_sensor(0x0C0A, 0x0101);
		write_cmos_sensor(0x0C0C, 0x0000);
		write_cmos_sensor(0x0C0E, 0x0000);
		write_cmos_sensor(0x0C10, 0x0000);
		write_cmos_sensor(0x0C12, 0x0000);
