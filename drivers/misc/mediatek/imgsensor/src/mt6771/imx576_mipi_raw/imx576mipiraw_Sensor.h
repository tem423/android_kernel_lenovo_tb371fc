...
struct imgsensor_mode_struct {
	...
	kal_uint16 grabwindow_width;  /* record different mode's
				       * width of grabwindow
				       */
	kal_uint16 grabwindow_height; /* record different mode's
...
/*#endif*/
	...
	/* record sensor support all write id addr, only supprt 4must
	 * end with 0xff
	 */
