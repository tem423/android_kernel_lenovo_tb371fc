...
#include "imx214mipi_Sensor.h"

/**********************Modify Following Strings for Debug**********************/
#define PFX "IMX214_camera_sensor"
#define LOG_1 LOG_INF("IMX214,MIPI 4LANE\n")
#define LOG_2 LOG_INF(\
	"preview 2104*1560@30fps;\n")
/***********************   Modify end    **************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value = 0xf61b7b7c, /* checksum value for Camera Auto Test */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 4208, 3120,    0,  0, 4208, 3120, 2104,  1560,
		0000,  376, 2104,  1184,    0,  0, 2104, 1184}, //hight speed video
	{ 4208, 3120,    0,  0, 4208, 3120, 2104,  1560,
		0000,  376, 2104,  1184,    0,  0, 2104, 1184}  // slim video
};
...
kal_uint16 IMX214MIPI_sensorGainMapping[IMX214MIPI_MaxGainIndex][2] = {
...
static void set_dummy(void)
{
	 ...
	 *
	 *write_cmos_sensor(0x0340, ctx->frame_length >> 8);
	 *write_cmos_sensor(0x0341, ctx->frame_length & 0xFF);
	 */
}				/*    set_dummy  */
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (gain <= 8*BASEGAIN) { //< 8x gain
		for (iI = 0; iI < (IMX214MIPI_MaxGainIndex-1); iI++) {
			if (gain <= IMX214MIPI_sensorGainMapping[iI][0])
				break;
		}
		reg_gain = IMX214MIPI_sensorGainMapping[iI][1];
	} else
...
static kal_uint16 imx214_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx214[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0101, 0x00,
	0x0105, 0x01,
...
static void sensor_init(void)
{
	...
	LOG_INF("E\n");
	imx214_table_write_cmos_sensor(addr_data_pair_init_imx214,
	sizeof(addr_data_pair_init_imx214) / sizeof(kal_uint16));
	LOG_INF("L\n");
}				/*    sensor_init  */
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		/* read_imx214_DCC((kal_uint16 )(*feature_data),
