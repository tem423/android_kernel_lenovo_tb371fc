...
extern unsigned int s5k4h7_read_otpdata(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);
extern unsigned int gc08a3_read_otpdata(struct i2c_client *client, unsigned int addr, unsigned char *data, unsigned int size);

struct stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	/*Below is commom sensor */
	{S5K4H7_SENSOR_ID, 0x20, s5k4h7_read_otpdata},
	{HI1339_SENSOR_ID, 0xA2, Common_read_region},
	{HI1339OFILM_SENSOR_ID, 0xA2, Common_read_region},
	...
	{GC08A3_SENSOR_ID, 0x62, gc08a3_read_otpdata},
