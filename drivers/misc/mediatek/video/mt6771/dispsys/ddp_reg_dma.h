...
#define DISP_REG_RDMA_MEM_GMC_SETTING_1		(DISPSYS_RDMA0_BASE+0x034)
	...
	#define MEM_GMC_SETTING_1_FLD_ULTRA_THRESHOLD_HIGH \
						REG_FLD_MSB_LSB(27, 16)
	#define FLD_RG_VALID_THRESHOLD_BLOCK_ULTRA	REG_FLD_MSB_LSB(30, 30)
	#define FLD_RG_VDE_BLOCK_ULTRA		REG_FLD_MSB_LSB(31, 31)
...
#define DST_UV_PITCH_FLD_UV_DST_W_IN_BYTE		\
						REG_FLD_MSB_LSB(15, 0)
