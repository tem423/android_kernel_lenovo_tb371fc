...
static const struct hid_device_id mt_devices[] = {
	...
	{ .driver_data = MT_CLS_HOLTEX,
		HID_DEVICE(BUS_I2C, HID_GROUP_ANY,
			I2C_VENDOR_ID_HT32F5,
			I2C_PRODUCT_ID_HT32F5) },
	{ .driver_data = MT_CLS_HOLTEX,
		HID_DEVICE(BUS_I2C, HID_GROUP_ANY,
			I2C_VENDOR_ID_HT32F5_TMP,
			I2C_PRODUCT_ID_HT32F5_TMP) },
	{ .driver_data = MT_CLS_HOLTEX,
		HID_DEVICE(BUS_I2C, HID_GROUP_ANY,
			I2C_VENDOR_ID_HT32F5_SPR,
			I2C_PRODUCT_ID_HT32F5_SPR) },
