...
//static struct notifier_block gpu_idle_notifier; //to-do
...
int mtk_platform_init(struct platform_device *pdev, struct kbase_device *kbdev)
{
	...
	//gpu_idle_notifier.notifier_call = gpu_idle_notifier_callback;//to-do
	//mtk_idle_notifier_register(&gpu_idle_notifier);//to-do
