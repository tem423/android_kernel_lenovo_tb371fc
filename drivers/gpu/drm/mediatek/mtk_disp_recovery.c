...
/*Spruce code for OSPURCET-2882 by zhuhao6 at 2023/3/9 start*/
		...
		if(gpiod_get_value(panel_ext->params->te_gpio)) {
...
/*Spruce code for OSPURCET-1219 by zhuhao at 2023/2/9 start*/
	extern bool mipi_ready;
	extern bool mipi_delay;
...
/*Spruce code for OSPURCET-1219 by zhuhao at 2023/2/9 start*/
		if(mipi_ready == false && mipi_delay == true)
			continue;
		else if(mipi_ready == true && mipi_delay == false) {
		/*Spruce code for OSPURCET-3296 by zhangkx10 at 2023/3/15 start*/
			mipi_ready = false;
			continue;
		/*Spruce code for OSPURCET-3296 by zhangkx10 at 2023/3/15 end*/
		}
/*Spruce code for OSPURCET-1219 by zhuhao at 2023/2/9 start*/
