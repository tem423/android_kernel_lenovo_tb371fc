...
#define ENABLE_MIPI_TX_PATTERN_GENERATOR		FALSE
#define ENABLE_MIPI_TX_VRR_PATTERN_GENERATOR	FALSE

/* TRUE: select tx clock from external, FALSE: select tx clock from rx */
#define ENABLE_MIPI_TX_EXTERNAL_MCLK			FALSE
/* current config for BOE TV108QDM-NH4-D850 1600x2560 */
#define ENABLE_MIPI_TX_OUTPUT_CLOCK_CONTINUOUS	TRUE
#define ENABLE_MIPI_TX_VRR_DETECT				FALSE
...
#define MIPI_RX_ADJUST_LANE_DATA_SKEW			FALSE
...
#define ENABLE_MIPI_TX_HS_AUTO_SET				FALSE
...
/*Spruce code for OSPURCET-1648 by zhuhao6 at 2023/2/22 start*/
#define MIPI_TX_HS_TRAIL					0x04
/*Spruce code for OSPURCET-1648 by zhuhao6 at 2023/2/22 end*/
...
#define ENABLE_MIPI_TX_LP_BYPASS				FALSE
#define ENABLE_MIPI_TX_LP_BYPASS_OPTION_FIX		FALSE
#define MIPI_TX_ENABLE_INITIAL_FIRE_LP_CMD		FALSE
/*Spruce code for OSPURCET-1280 by zhangkx10 at 2023/2/16 start*/
#define ENABLE_MIPI_TX_HS_AUTO_READ			FALSE
/*Spruce code for OSPURCET-1280 by zhangkx10 at 2023/2/16 end*/
#define ENABLE_MIPI_RX_SYNC_ERROR_BIT			FALSE
