	...
	enum power_supply_property psp, union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_ONLINE:
		...
		if ((mtk_chg->chg_type != CHARGER_UNKNOWN) && hardinfo_get_chg_online())
			val->intval = 1;
		break;
...
/* Spruce code for OSPURCET-2761 by yeyz5 at 2023.03.14 start */
				msleep(5000);
/* Spruce code for OSPURCET-2761 by yeyz5 at 2023.03.14 end */
