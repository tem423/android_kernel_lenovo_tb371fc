...
/*Linden code for JLINDEN-1268 by zhoujj21 at 20230111 start*/
		//if (!val1)
		//	break;
		rc = smb1355_clk_request(chip, !val1);
...
#define SMB1355_MAX_PARALLEL_FCC_UA	2000000
...
/*Linden code for JLINDEN-17 by kangkai4 at 20221128 start*/
	#ifdef CONFIG_HQ_SYSFS_SUPPORT
/*Linden code for JLINDEN-5099 by kangkai4 at 20230314 start*/
	hq_deregister_hw_info(HWID_SLAVE_CHARGE, "fail");
/*Linden code for JLINDEN-5099 by kangkai4 at 20230314 end*/
	hq_register_hw_info(HWID_SLAVE_CHARGE, "SMB-1355-0-36BWLNSP-TR-01-0-04");
	#endif
/*Linden code for JLINDEN-17 by kangkai4 at 20221128 end*/
	return rc;
...
/*Linden code for JLINDEN-17 by kangkai4 at 20221128 start*/
	#ifdef CONFIG_HQ_SYSFS_SUPPORT
	hq_register_hw_info(HWID_SLAVE_CHARGE, "fail");
	#endif
/*Linden code for JLINDEN-17 by kangkai4 at 20221128 end*/
