...
static const struct mtk_mux top_muxes[] = {
	/* CLK_CFG_0 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AXI, "axi_sel", axi_parents, CK_CFG_0,
		CK_CFG_0_SET, CK_CFG_0_CLR, 0, 2, 7, CLK_CFG_UPDATE, 0, CLK_IS_CRITICAL),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_MM, "mm_sel", mm_parents, CK_CFG_0,
		CK_CFG_0_SET, CK_CFG_0_CLR, 8, 3, 15, CLK_CFG_UPDATE, 1),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_IMG, "img_sel", img_parents, CK_CFG_0,
		CK_CFG_0_SET, CK_CFG_0_CLR, 16, 3, 23, CLK_CFG_UPDATE, 2),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_CAM, "cam_sel", cam_parents, CK_CFG_0,
		CK_CFG_0_SET, CK_CFG_0_CLR, 24, 4, 31, CLK_CFG_UPDATE, 3),

	/* CLK_CFG_1 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DSP, "dsp_sel", dsp_parents, CK_CFG_1,
		CK_CFG_1_SET, CK_CFG_1_CLR, 0, 4, 7, CLK_CFG_UPDATE, 4),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DSP1, "dsp1_sel", dsp1_parents, CK_CFG_1,
		CK_CFG_1_SET, CK_CFG_1_CLR, 8, 4, 15, CLK_CFG_UPDATE, 5),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DSP2, "dsp2_sel", dsp2_parents, CK_CFG_1,
		CK_CFG_1_SET, CK_CFG_1_CLR, 16, 4, 23, CLK_CFG_UPDATE, 6),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_IPU_IF, "ipu_if_sel", ipu_if_parents, CK_CFG_1,
		CK_CFG_1_SET, CK_CFG_1_CLR, 24, 4, 31, CLK_CFG_UPDATE, 7),


	/* CLK_CFG_2 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_MFG, "mfg_sel", mfg_parents, CK_CFG_2,
		CK_CFG_2_SET, CK_CFG_2_CLR, 0, 2, 7, CLK_CFG_UPDATE, 8),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_F52M_MFG, "f52m_mfg_sel",
		f52m_mfg_parents, CK_CFG_2, CK_CFG_2_SET, CK_CFG_2_CLR,
		8, 2, 15, CLK_CFG_UPDATE, 9),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_CAMTG, "camtg_sel", camtg_parents, CK_CFG_2,
		CK_CFG_2_SET, CK_CFG_2_CLR, 16, 3, 23, CLK_CFG_UPDATE, 10),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_CAMTG2, "camtg2_sel", camtg2_parents, CK_CFG_2,
		CK_CFG_2_SET, CK_CFG_2_CLR, 24, 3, 31, CLK_CFG_UPDATE, 11),

	/* CLK_CFG_3 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_CAMTG3, "camtg3_sel", camtg3_parents, CK_CFG_3,
		CK_CFG_3_SET, CK_CFG_3_CLR, 0, 3, 7, CLK_CFG_UPDATE, 12),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_CAMTG4, "camtg4_sel", camtg4_parents, CK_CFG_3,
		CK_CFG_3_SET, CK_CFG_3_CLR, 8, 3, 15, CLK_CFG_UPDATE, 13),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_UART, "uart_sel", uart_parents, CK_CFG_3,
		CK_CFG_3_SET, CK_CFG_3_CLR, 16, 1, 23, CLK_CFG_UPDATE, 14),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SPI, "spi_sel", spi_parents, CK_CFG_3,
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_MSDC30_2, "msdc30_2_sel",
		msdc30_2_parents, CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR,
		24, 3, 31, CLK_CFG_UPDATE, 19),

	/* CLK_CFG_5 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_AUDIO, "audio_sel", audio_parents, CK_CFG_5,
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_PMICSPI, "pmicspi_sel",
	...
	/* CLK_CFG_6 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_ATB, "atb_sel", atb_parents, CK_CFG_6,
		CK_CFG_6_SET, CK_CFG_6_CLR, 0, 2, 7, CLK_CFG_UPDATE, 24),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SSPM, "sspm_sel", sspm_parents, CK_CFG_6,
		CK_CFG_6_SET, CK_CFG_6_CLR, 8, 3, 15, CLK_CFG_UPDATE, 25),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DPI0, "dpi0_sel", dpi0_parents, CK_CFG_6,
		CK_CFG_6_SET, CK_CFG_6_CLR, 16, 4, 23, CLK_CFG_UPDATE, 26),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SCAM, "scam_sel", scam_parents, CK_CFG_6,
		CK_CFG_6_SET, CK_CFG_6_CLR, 24, 1, 31, CLK_CFG_UPDATE, 27),

	/* CLK_CFG_7 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DISP_PWM, "disppwm_sel",
		disppwm_parents, CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		0, 3, 7, CLK_CFG_UPDATE, 28),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_USB_TOP, "usb_top_sel",
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SPM, "spm_sel", spm_parents, CK_CFG_7,
		CK_CFG_7_SET, CK_CFG_7_CLR, 24, 1, 31, CLK_CFG_UPDATE1, 0),

	/* CLK_CFG_8 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_I2C, "i2c_sel", i2c_parents, CK_CFG_8,
		CK_CFG_8_SET, CK_CFG_8_CLR, 0, 2, 7, CLK_CFG_UPDATE1, 1),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SCP, "scp_sel", scp_parents, CK_CFG_8,
		CK_CFG_8_SET, CK_CFG_8_CLR, 8, 3, 15, CLK_CFG_UPDATE1, 2),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SENINF, "seninf_sel", seninf_parents, CK_CFG_8,
		CK_CFG_8_SET, CK_CFG_8_CLR, 16, 2, 23, CLK_CFG_UPDATE1, 3),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DXCC, "dxcc_sel", dxcc_parents, CK_CFG_8,
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_FUFS, "fufs_sel", fufs_parents, CK_CFG_9,
		CK_CFG_9_SET, CK_CFG_9_CLR, 24, 2, 31, CLK_CFG_UPDATE1, 8),
	/* CLK_CFG_10 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_AUD_1, "aud_1_sel", aud_1_parents, CK_CFG_10,
		CK_CFG_10_SET, CK_CFG_10_CLR, 0, 1, 7, CLK_CFG_UPDATE1, 9),
	MUX_GATE_CLR_SET_UPD(TOP_MUX_AUD_2, "aud_2_sel", aud_2_parents, CK_CFG_10,
...
CLK_OF_DECLARE(mtk_audio, "mediatek,audsys", mtk_audio_init);
...
CLK_OF_DECLARE(mtk_imgsys, "mediatek,mt6771-imgsys", mtk_imgsys_init);
...
CLK_OF_DECLARE(mtk_vdec_top_global_con, "mediatek,vdec_gcon",
