...
<<<<<<< HEAD
		 ...
		 * slow down from the base timing; 120->60 and 120->30 are real,
		 * but 120->144 computes vfp = 26 - 341 = -315 (and 90 negative
		 * as well), so such a switch can never complete and wedges the
		 * composer's ProcessActiveConfigChange usleep loop -> SF main
